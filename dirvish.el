...
(defcustom dirvish-preview-dispatchers
  `(,(if (memq system-type '(ms-dos windows-nt)) 'video-mtn 'video)
    image gif audio epub archive font pdf 3d)
...
- 3d: preview 3d models with thumbnail generated by `f3d'.
...
(defconst dirvish-model-exts '("off" "3ds" "gml" "dicom" "gltf" "mhd" "nrrd" "obj" "ply" "pts" "stl" "vrml" "vtk" "vtu" "vtp" "vti" "vtr" "vts" "vtm" "splat"))
...
(defconst dirvish-binary-exts (append dirvish-image-exts dirvish-video-exts dirvish-audio-exts dirvish-font-exts dirvish-model-exts dirvish-archive-exts '("pdf" "epub" "gif" "icns")))
